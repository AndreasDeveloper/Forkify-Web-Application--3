...
const formatCount = count => {
    ...
    return '?'; // Instead of having undefined in HTML
};

// Create Ingredient Function that is connected to renderRecipe funtion. | As we don't know how many ingredients there are
